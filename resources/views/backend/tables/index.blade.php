            ...
            <div class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                ...
                <table class="min-w-full">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">Salle</th>
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{$table->name}}

                            </td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $table->status }}

                            </td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $table->chair }}

                            </td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $table->couvert }}

                            </td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200"><img src="{{ $table->image }}" width="120" height="120" alt="{{$table->name}}"/></td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $table->room_id }}</td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">

                                    <a class="text-indigo-600 hover:text-indigo-900" href="/tables/{{$table->id}}">
                                    ...
                                    <a href="/tables/{{$table->id}}/edit " class="text-gray-600 text-indigo-600 hover:text-indigo-900">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
