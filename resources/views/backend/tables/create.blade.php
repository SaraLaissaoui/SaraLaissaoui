...
<div>
    <div class="flex flex-col items-center min-h-screen bg-gray-100 sm:justify-center sm:pt-0">
        <div class="flex justify-start py-2">
                <a href="/tables" class="px-4 py-2 font-bold text-gray-800 bg-gray-300 rounded-l hover:bg-gray-400">Back</a>
            </div>
            ...
            <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                <form method="POST" action="/tables" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="text" name="status" placeholder="statut" />
                    </div>
                    ...
                    <div>
                        ...
                        <input class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="number" name="chair" placeholder="" />
                    </div>
