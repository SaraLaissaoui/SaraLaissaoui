...
<div class="max-w-4xl mx-auto mt-8">
    ...
    <div class="flex justify-end mt-10">
        <a href="{{ route('inventory.create') }}" class="px-2 py-1 rounded-md bg-blue-500 text-sky-100 hover:bg-blue-700">Liste des achats</a>
    </div>
            ...
            <div class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                ...
                <table class="min-w-full">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">Quantité</th>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <form action="{{ route('inventory.destroy',$element->id) }}" method="POST">
                                    ...
                                    <a class="text-indigo-600 hover:text-indigo-900" href="{{ route('inventory.show',$element->id) }}">
